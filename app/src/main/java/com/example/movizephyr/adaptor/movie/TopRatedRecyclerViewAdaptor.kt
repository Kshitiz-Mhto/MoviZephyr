...
import com.example.movizephyr.modal.movies.toprated.Result

class TopRatedRecyclerViewAdaptor(val topratedList: List<Result>?, val context: Context) : RecyclerView.Adapter<MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        var index_element = topratedList!![position]
