...
import com.example.movizephyr.adaptor.slideradaptor.SliderAdaptor
    ...
    override fun onCreateView(
       ...
       val responseLiveData: LiveData<Response<UpComing>> = liveData {
        ...
        responseLiveData.observe(this, Observer {
            val foodList = it.body()?.results?.toImmutableList()
            if (foodList != null) {
                recyclerView.adapter = SliderAdaptor(foodList, context!!)
            }
        })
